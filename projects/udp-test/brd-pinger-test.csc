...
<simconf>
  ...
  <simulation>
    ...
    <motetype>
      ...
      <source>[CONFIG_DIR]/broadcast_pinger.c</source>
      <commands>make broadcast_pinger.cooja TARGET=cooja</commands>
    ...
    <motetype>
      ...
      <source EXPORT="discard">[CONFIG_DIR]/broadcast_pinger.c</source>
      <commands EXPORT="discard">make broadcast_pinger.sky TARGET=sky</commands>
      <firmware EXPORT="copy">[CONFIG_DIR]/broadcast_pinger.sky</firmware>
      <moteinterface>se.sics.cooja.interfaces.Position</moteinterface>
      <moteinterface>se.sics.cooja.interfaces.RimeAddress</moteinterface>
    ...
    <mote>
      ...
      <interface_config>
        ...
        <x>55.37795943825955</x>
        <y>54.50650296044725</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
    ...
    <mote>
      ...
      <interface_config>
        se.sics.cooja.interfaces.Position
        <x>50.963680381805474</x>
        <y>15.723908393029278</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        se.sics.cooja.mspmote.interfaces.MspMoteID
    ...
    <mote>
      ...
      <interface_config>
        se.sics.cooja.interfaces.Position
        <x>76.50343777986122</x>
        <y>23.92185521215828</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        se.sics.cooja.mspmote.interfaces.MspMoteID
    ...
    <mote>
      ...
      <interface_config>
        se.sics.cooja.interfaces.Position
        <x>40.873899681339005</x>
        <y>28.966745562391512</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        se.sics.cooja.mspmote.interfaces.MspMoteID
    ...
    <mote>
      ...
      <interface_config>
        se.sics.cooja.interfaces.Position
        <x>38.03614885933281</x>
        <y>45.04733355375994</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        se.sics.cooja.mspmote.interfaces.MspMoteID
    ...
    <mote>
      ...
      <interface_config>
        se.sics.cooja.interfaces.Position
        <x>62.009233954158084</x>
        <y>32.06961075735006</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        se.sics.cooja.mspmote.interfaces.MspMoteID
    ...
    <mote>
      ...
      <interface_config>
        se.sics.cooja.interfaces.Position
        <x>45.60348438468266</x>
        <y>39.68713755663713</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        se.sics.cooja.mspmote.interfaces.MspMoteID
    ...
    <mote>
      ...
      <interface_config>
        se.sics.cooja.interfaces.Position
        <x>84.07077330521105</x>
        <y>48.831001316434865</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        se.sics.cooja.mspmote.interfaces.MspMoteID
    ...
    <mote>
      ...
      <interface_config>
        se.sics.cooja.interfaces.Position
        <x>80.49330212005707</x>
        <y>41.38653757704432</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        se.sics.cooja.mspmote.interfaces.MspMoteID
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>3.1715258190418942 0.0 0.0 3.1715258190418942 57.36737183570509 13.131218555258101</viewport>
    </plugin_config>
    <width>400</width>
    <z>2</z>
    <height>400</height>
